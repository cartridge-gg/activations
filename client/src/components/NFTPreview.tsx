...
// Import SVG assets as embedded strings (inner content only)
const BG_SVG = `<g clip-path="url(#clip0_1339_21)">
<path d="M1024.5 0H0.5V1024H1024.5V0Z" fill="black"/>
<path opacity="0.7" d="M-310.082 289.052C-310.082 289.052 660.605 623.53 512.5 289.052C364.395 -45.4267 1335.08 289.052 1335.08 289.052V1464.16H-310.082L-310.082 289.052Z" fill="url(#paint0_linear_1339_21)"/>
</g>
<defs>
...
const RACK_SVG = `<g transform="translate(220.5, 273.5)">
  <defs>
    <style>
      .st0 {
        fill: #e9283a;
...
function getSwordAt(yOffset: number): string {
  return `<g transform="translate(135, ${yOffset})">
    ...
    <g transform="translate(520, 90)">${OCCLUSION}</g>
  </g>`;
}

function generateSvg(progress: TrialProgress): string {
  // Start SVG with background and centered rack
  let svg = `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1025 1024' width='100%' height='100%'>`;
  svg += BG_SVG;
  svg += RACK_SVG;
